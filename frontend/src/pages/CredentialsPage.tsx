...
import { Key, MoreHorizontal, Pencil, Trash2, Shield, Plus, Search, Server } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Devices Using</CardTitle>
            <Server className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{totalDevicesUsing}</div>
            <p className="text-xs text-muted-foreground">
              Devices with assigned credentials
            </p>
          </CardContent>
        </Card>
        <Card>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle>Credential Store</CardTitle>
              <CardDescription>
