        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        default=60, help_text="Interval in seconds between health checks"
                    ),
                ),
                (
                    "priority",
                ...
                (
                    "enabled",
                    models.BooleanField(
                        default=True, help_text="Whether this region is enabled for job routing"
                    ),
                ),
                (
                    "description",
                    models.TextField(
                        blank=True, help_text="Optional description of the region", null=True
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["customer"], name="core_region_custome_c5e5ea_idx"),
                    models.Index(fields=["identifier"], name="core_region_identif_b0598b_idx"),
                    models.Index(fields=["health_status"], name="core_region_health__2045bc_idx"),
                    models.Index(fields=["enabled"], name="core_region_enabled_a94eff_idx"),
                ],
