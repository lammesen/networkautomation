...
class PluginConfig(models.Model):
    ...
    settings = models.JSONField(
        default=dict, blank=True, help_text="Plugin-specific settings"
    )
...
class CustomerPluginConfig(models.Model):
    ...
    customer = models.ForeignKey(
        Customer, on_delete=models.CASCADE, related_name="plugin_configs"
    )
...
class PluginAuditLog(models.Model):
    ...
    plugin = models.ForeignKey(
        PluginConfig, on_delete=models.CASCADE, related_name="audit_logs"
    )
    customer = models.ForeignKey(
        Customer,
