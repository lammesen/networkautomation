    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='User-friendly name for this security key', max_length=100)),
                ('credential_id', models.BinaryField(help_text='WebAuthn credential ID', unique=True)),
