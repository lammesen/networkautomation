    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "total_lines",
                    models.IntegerField(default=0, help_text="Total lines in diff output"),
                ),
                (
                    "has_changes",
                    models.BooleanField(
                ...
                (
                    "diff_summary",
                    models.TextField(blank=True, help_text="Summary of major changes"),
                ),
                (
                    "device",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "resolution_notes",
                    models.TextField(blank=True, help_text="Notes about alert resolution"),
                ),
                (
                    "acknowledged_by",
                    models.ForeignKey(
