    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "username",
                    models.CharField(
                        help_text="ServiceNow username for API access", max_length=100
                    ),
                ),
                (
                    "_password",
                    models.TextField(
                        db_column="password", help_text="Encrypted ServiceNow password (required)"
                    ),
                ),
                (
                    "cmdb_table",
                ...
                (
                    "auto_sync_enabled",
                    models.BooleanField(
                        default=False, help_text="Whether automatic sync is enabled"
                    ),
                ),
                (
                    "create_incidents_on_failure",
                    models.BooleanField(
                        default=False, help_text="Automatically create incidents when jobs fail"
                    ),
                ),
                (
                    "incident_category",
                    models.CharField(
                        blank=True, help_text="Default incident category", max_length=100, null=True
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "change_sys_id",
                    models.CharField(help_text="ServiceNow change request sys_id", max_length=32),
                ),
                (
                    "state",
                    models.IntegerField(
            ...
            options={
                "ordering": ["-created_at"],
                "indexes": [
                    models.Index(fields=["config"], name="devices_ser_config__19e8e4_idx"),
                    models.Index(fields=["job"], name="devices_ser_job_id_75c46a_idx"),
                    models.Index(fields=["change_number"], name="devices_ser_change__88a490_idx"),
                    models.Index(fields=["state"], name="devices_ser_state_9fc598_idx"),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "incident_number",
                    models.CharField(
                        help_text="ServiceNow incident number (e.g., INC0012345)", max_length=50
                    ),
                ),
                (
                    "incident_sys_id",
                    models.CharField(help_text="ServiceNow incident sys_id", max_length=32),
                ),
                (
                    "state",
                    models.IntegerField(
            ...
            options={
                "ordering": ["-created_at"],
                "indexes": [
                    models.Index(fields=["config"], name="devices_ser_config__574f65_idx"),
                    models.Index(fields=["job"], name="devices_ser_job_id_0c5360_idx"),
                    models.Index(fields=["incident_number"], name="devices_ser_inciden_7f4d53_idx"),
                    models.Index(fields=["state"], name="devices_ser_state_567e51_idx"),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                "ordering": ["-started_at"],
                "indexes": [
                    models.Index(fields=["config"], name="devices_ser_config__d46d39_idx"),
                    models.Index(fields=["status"], name="devices_ser_status_a2e743_idx"),
                    models.Index(fields=["started_at"], name="devices_ser_started_c8765f_idx"),
                ],
            },
        ),
    ]
